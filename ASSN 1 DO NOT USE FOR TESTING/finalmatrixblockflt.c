...
int main ()
{
    float *mtx1 = calloc(1000 * 1000, sizeof(float));
    float *mtx2 = calloc(1000 * 1000, sizeof(float));
    float *mtx3 = calloc(2000 * 2000, sizeof(float));
    float *mtx4 = calloc(2000 * 2000, sizeof(float));
    float *mtx5 = calloc(3000 * 3000, sizeof(float));
    float *mtx6 = calloc(3000 * 3000, sizeof(float));
    float *mtx7 = calloc(4000 * 4000, sizeof(float));
    float *mtx8 = calloc(4000 * 4000, sizeof(float));
    float *mtx9 = calloc(5000 * 5000, sizeof(float));
    float *mtx10 = calloc(5000 * 5000, sizeof(float));

    float *mtx1out = calloc(1000 * 1000, sizeof(float));
    float *mtx2out = calloc(2000 * 2000, sizeof(float));
    float *mtx3out = calloc(3000 * 3000, sizeof(float));
    float *mtx4out = calloc(4000 * 4000, sizeof(float));
    float *mtx5out = calloc(5000 * 5000, sizeof(float));
    ...
    printf("Timing Cache-optimized (block) multiplication for flt...\r\n");

    start = clock();
    blockflt(mtx1,mtx2, mtx1out, 1000, 1000, 1000, 1000,block1);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("1000x1000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockflt(mtx3,mtx4, mtx2out, 2000, 2000, 2000, 2000,block2);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("2000x2000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockflt(mtx5,mtx6, mtx3out, 3000, 3000, 3000, 3000,block3);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("3000x3000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockflt(mtx7,mtx8, mtx4out, 4000, 4000, 4000, 4000,block4);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("4000x4000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockflt(mtx9,mtx10, mtx5out, 5000, 5000, 5000, 5000,block5);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;

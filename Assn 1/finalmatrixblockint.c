...
int main ()
{
    int16_t *mtx1 = calloc(1000 * 1000, sizeof(int16_t));
    int16_t *mtx2 = calloc(1000 * 1000, sizeof(int16_t));
    int16_t *mtx3 = calloc(2000 * 2000, sizeof(int16_t));
    int16_t *mtx4 = calloc(2000 * 2000, sizeof(int16_t));
    int16_t *mtx5 = calloc(3000 * 3000, sizeof(int16_t));
    int16_t *mtx6 = calloc(3000 * 3000, sizeof(int16_t));
    int16_t *mtx7 = calloc(4000 * 4000, sizeof(int16_t));
    int16_t *mtx8 = calloc(4000 * 4000, sizeof(int16_t));
    int16_t *mtx9 = calloc(5000 * 5000, sizeof(int16_t));
    int16_t *mtx10 = calloc(5000 * 5000, sizeof(int16_t));
    ...
    start = clock();
    blockint(mtx3,mtx4, mtx2out, 2000, 2000, 2000, 2000,block2);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("2000x2000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockint(mtx5,mtx6, mtx3out, 3000, 3000, 3000, 3000,block3);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("3000x3000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockint(mtx7,mtx8, mtx4out, 4000, 4000, 4000, 4000,block4);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
    printf("4000x4000 took %d seconds, %d milliseconds: \r\n", msec/1000, msec%1000);  

    start = clock();
    blockint(mtx9,mtx10, mtx5out, 5000, 5000, 5000, 5000,block5);
    endtimer = clock() - start;
    msec= endtimer *1000 / CLOCKS_PER_SEC;
